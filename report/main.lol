\contentsline {lstlisting}{\numberline {1}{\ignorespaces \texttt {DFSA} class declaration (lexer/DFSA.hpp).}}{1}{lstlisting.0.1}%
\contentsline {lstlisting}{\numberline {2}{\ignorespaces Code representation of Figure~\ref {fig:comments} in the \texttt {LexerDirector} class (lexer/LexerDirector.cpp).}}{7}{lstlisting.0.2}%
\contentsline {lstlisting}{\numberline {3}{\ignorespaces Registration of the hexadecimal ($H$) category checker (lexer/LexerDirector.cpp).}}{8}{lstlisting.0.3}%
\contentsline {lstlisting}{\numberline {4}{\ignorespaces Construction of a \texttt {Lexer} (lexer/LexerBuilder.cpp).}}{8}{lstlisting.0.4}%
\contentsline {lstlisting}{\numberline {5}{\ignorespaces The \texttt {updateLocationState()} \texttt {Lexer} method (lexer/Lexer.cpp).}}{9}{lstlisting.0.5}%
\contentsline {lstlisting}{\numberline {6}{\ignorespaces Error handling mechanism in the \texttt {nextToken()} \texttt {Lexer} method (lexer/Lexer.cpp).}}{9}{lstlisting.0.6}%
\contentsline {lstlisting}{\numberline {7}{\ignorespaces The \texttt {Runner} constructor passing \texttt {mLexer} into the \texttt {Parser} constructor (runner/Runner.cpp).}}{10}{lstlisting.0.7}%
\contentsline {lstlisting}{\numberline {8}{\ignorespaces Mechanism for internally storing types within the compiler (parl/Core.hpp).}}{15}{lstlisting.0.8}%
\contentsline {lstlisting}{\numberline {9}{\ignorespaces The \texttt {Primitive} class declaration (parl/Core.hpp).}}{15}{lstlisting.0.9}%
\contentsline {lstlisting}{\numberline {10}{\ignorespaces An size unbounded type in {C\nolinebreak \raisebox {.25ex}{\scriptsize \bfseries {++}}}{} (parl/Core.hpp).}}{16}{lstlisting.0.10}%
\contentsline {lstlisting}{\numberline {11}{\ignorespaces The \texttt {FunctionCall} AST node class (parl/AST.hpp).}}{17}{lstlisting.0.11}%
\contentsline {lstlisting}{\numberline {12}{\ignorespaces The \texttt {Binary} AST node class (parl/AST.hpp).}}{18}{lstlisting.0.12}%
\contentsline {lstlisting}{\numberline {13}{\ignorespaces The \texttt {Unary} AST node class (parl/AST.hpp).}}{18}{lstlisting.0.13}%
\contentsline {lstlisting}{\numberline {14}{\ignorespaces The \texttt {moveWindow()} \texttt {Parser} methods (parser/Parser.cpp).}}{19}{lstlisting.0.14}%
\contentsline {lstlisting}{\numberline {15}{\ignorespaces The \texttt {nextToken()} \texttt {Parser} methods (parser/Parser.cpp).}}{20}{lstlisting.0.15}%
\contentsline {lstlisting}{\numberline {16}{\ignorespaces The \texttt {consume()} Parser method (parser/Parser.hpp).}}{21}{lstlisting.0.16}%
\contentsline {lstlisting}{\numberline {17}{\ignorespaces Usage of the \texttt {consume()} method in the \texttt {formalParam()} generator method (parser/Parser.cpp).}}{21}{lstlisting.0.17}%
\contentsline {lstlisting}{\numberline {18}{\ignorespaces The \texttt {peek()} \texttt {Parser} method (parser/Parser.cpp).}}{22}{lstlisting.0.18}%
\contentsline {lstlisting}{\numberline {19}{\ignorespaces The abort functionality present in the codebase (parl/Core.hpp).}}{22}{lstlisting.0.19}%
\contentsline {lstlisting}{\numberline {20}{\ignorespaces The \texttt {SyncParser} exception and the \texttt {error()} method which kick-starts the synchronisation process (parser/Parser.hpp).}}{24}{lstlisting.0.20}%
\contentsline {lstlisting}{\numberline {21}{\ignorespaces The \texttt {synchronize()} method in the \texttt {Parser} class (parser/Parser.cpp).}}{24}{lstlisting.0.21}%
\contentsline {lstlisting}{\numberline {22}{\ignorespaces The \texttt {ifStmt()} node generator method in the \texttt {Parser} class (parser/Parser.cpp).}}{26}{lstlisting.0.22}%
\contentsline {lstlisting}{\numberline {23}{\ignorespaces The main body of methods in the \texttt {Parser} class (parser/Parser.hpp).}}{27}{lstlisting.0.23}%
\contentsline {lstlisting}{\numberline {24}{\ignorespaces The parse segment of the \texttt {run()} method in the Runner class (runner/Runner.cpp).}}{28}{lstlisting.0.24}%
\contentsline {lstlisting}{\numberline {25}{\ignorespaces The \texttt {debugParsing()} method in the \texttt {Runner} class (runner/Runner.cpp).}}{29}{lstlisting.0.25}%
\contentsline {lstlisting}{\numberline {26}{\ignorespaces A segment of the pure virtual \texttt {Visitor} class (parl/Visitor.hpp).}}{30}{lstlisting.0.26}%
\contentsline {lstlisting}{\numberline {27}{\ignorespaces The \texttt {visit(core::PadRead *)} method in the \texttt {PrinterVisitor} (parser/PrinterVisitor.cpp).}}{31}{lstlisting.0.27}%
\contentsline {lstlisting}{\numberline {28}{\ignorespaces The \texttt {visit(Program *)} method in the \texttt {AnalysisVisitor} class, showing the hack used for resolving function symbols before-hand (analysis/AnalysisVisitor.cpp).}}{32}{lstlisting.0.28}%
\contentsline {lstlisting}{\numberline {29}{\ignorespaces The \texttt {Environment} class with \texttt {mChildren} highlighted (backend/Environment.hpp).}}{36}{lstlisting.0.29}%
\contentsline {lstlisting}{\numberline {30}{\ignorespaces The \texttt {pushEnv()} method in the \texttt {EnvStack} class (analysis/EnvStack.cpp).}}{38}{lstlisting.0.30}%
