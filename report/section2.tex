...
Additionally, some of the ground work for these improvements has
already been laid out in the internal type system see
\listref{internaltypesys} and \listref{primitive}.
